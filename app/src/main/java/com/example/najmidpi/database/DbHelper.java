    ...
    public ArrayList<SensorObject> getAllSensor() {
        ...
        try {
            ...
            while (!cursor.isAfterLast()) {
                ...
                object.setZarabaneGhalb(cursor.getInt(cursor.getColumnIndex(COL_ZARABENGHALB)));
                object.setVazn(cursor.getInt(cursor.getColumnIndex(COL_VAZN)));
                object.setGamShomar(cursor.getInt(cursor.getColumnIndex(COL_GAMSHOMAR)));
                object.setFesharSanj(cursor.getInt(cursor.getColumnIndex(COL_FESHARSANJ)));
